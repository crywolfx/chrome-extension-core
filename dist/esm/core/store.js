...
import { isObject, pick, objectKeys } from '../utils/type.js';
...
var ChromeStorage = /** @class */ (function () {
    ...
    ChromeStorage.prototype.set = function (key, value) {
        ...
        return new Promise(function (resolve) {
            var _a;
            var _b, _c;
            var isPlainObject = isObject(key);
            if (!_this.scope) {
                if (isPlainObject) {
                ...
                _this.getAll()
                    ...
                    if (isPlainObject) {
                        scopeData = __assign(__assign({}, scopeData), key);
                    }
                    else {
                        scopeData[key] = value;
                    }
    ...
    ChromeStorage.prototype.get = function (key) {
        ...
        return new Promise(function (resolve) {
            ...
            (_b = (_a = _this.runTimeApi) === null || _a === void 0 ? void 0 : _a.get) === null || _b === void 0 ? void 0 : _b.call(_a, reallyKey, function (res) {
                ...
                var mergeDefaultRes = cjs(_this.defaultValue, reallyRes !== null && reallyRes !== void 0 ? reallyRes : {});
                if (Array.isArray(key))
                    resolve(pick(mergeDefaultRes, key));
    ...
    ChromeStorage.prototype.getAll = function () {
        ...
        return new Promise(function (resolve) {
            ...
            (_b = (_a = _this.runTimeApi) === null || _a === void 0 ? void 0 : _a.get) === null || _b === void 0 ? void 0 : _b.call(_a, function (res) {
                var reallyRes = _this.scope ? res[_this.scope] : res;
                var mergeDefaultRes = __assign(__assign({}, _this.defaultValue), reallyRes);
        ...
        return new Promise(function (resolve) {
            ...
            if (_this.scope) {
                _this.runTimeApi.get(_this.scope, function (value) {
                    ...
                    var removedValue = (_c = (_b = objectKeys(valueData)) === null || _b === void 0 ? void 0 : _b.reduce) === null || _c === void 0 ? void 0 : _c.call(_b, function (pre, currentKey) {
    ...
    ChromeStorage.prototype.onChange = function (changes, areaName) {
        ...
        this.watcherSet.forEach(function (listener) {
            ...
            if (_this.scope) {
                ...
                if (!newValue_1)
                    return;
                var scopeChanges = objectKeys(newValue_1).reduce(function (pre, key) {
                    pre[key] = {
